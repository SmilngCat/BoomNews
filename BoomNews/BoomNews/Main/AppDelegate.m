...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	rootViewController.tabBar.backgroundImage = [UIImage imageNamed:@"down"];
	rootViewController.tabBar.tintColor = [UIColor colorWithRed:0.092 green:0.136 blue:1.000 alpha:1.000];
	...
	newsNavigationController.navigationBar.backgroundColor = [UIColor redColor];
	[newsNavigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"up"] forBarMetrics:UIBarMetricsDefault];
	...
	[videoNavigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"up"] forBarMetrics:UIBarMetricsDefault];
	...
	[mineNavigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"up"] forBarMetrics:UIBarMetricsDefault];
