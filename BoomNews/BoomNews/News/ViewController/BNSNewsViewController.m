...
- (void)loadUI {
	...
	//顶部的新闻类型选项栏
	self.newsTypeBar = [[[BNSNewsTypeScrollBar alloc] initWithFrame:CGRectMake(0, 0, width, HEIGHT_NEWSTYPEBAR)] autorelease];
	...
	CGFloat contentScrollViewY = HEIGHT_NEWSTYPEBAR;
